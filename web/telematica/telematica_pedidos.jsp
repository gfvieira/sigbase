            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a class="page-scroll" href="telematica_consulta.html" style="color: black">Consultar Pedido</a>
                        </li>
                        <li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="label label-warning label-mini"><%out.println(sate.getStatus());%></span></td>
                                    <%break;
                                        case 3:%>
                                <td><span class="label label-info label-mini"><%out.println(sate.getStatus());%></span></td>
                                    <%break;
                                    default:%>
                                <td><span class="label label-success label-mini"><%out.println(sate.getStatus());%></span></td>
                                        <%}%>
                                <td>
                                    <form class="col-sm-2 control-label" action="SateConsultOs.jsp" method="post">      
