                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h3 class="mb"><i class="fa fa-angle-double-right"></i> <b>Cadastro de Usuários</b></h3><br><br>
                                <%if (temp != null) {
                                        switch (Integer.parseInt(temp)) {
                                            case 0: %>
                                <div class="alert alert-success"><b>Sucesso!</b> Usuário cadastrado/atualizado com suscesso.</div>      				
                                <% break;
                                    case 1: %>
                                <div class="alert alert-danger"><b>Erro!</b> A operação não pode ser concluída. Contate o Administrador.</div>      				
                                <%break;
                                    case 2: %>
                                <div class="alert alert-warning"><b>Erro!</b> Usuário já possui cadastro.</div>      				
                                <%break;
                                        }
                                    }%>
                                <form class="form-horizontal style-form" action="CadastroUsuario.jsp" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" size="1" name="admin" required>
                                                <option value="">Selecione!</option>
